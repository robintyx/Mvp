package cn.microvideo.framework3.component.weixin.message.qy.plugins.kafka.consumer.config;
 ...
 */
@Configuration("MicrovideoKafkaConsumerConfiguration")
@EnableKafka
@Slf4j
@Getter
public class WeixinMessageKafkaConsumerConfiguration {
