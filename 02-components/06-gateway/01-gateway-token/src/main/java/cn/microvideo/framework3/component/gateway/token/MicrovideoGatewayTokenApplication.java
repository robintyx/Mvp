package cn.microvideo.framework3.component.gateway.token;
...
public class MicrovideoGatewayTokenApplication implements ApplicationRunner {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(MicrovideoGatewayTokenApplication.class).banner(banner).run(args);
