...
import cn.microvideo.framework3.component.web.websocket.app.plugins.executor.runnable.MicrovideoWebsocketMessageRunnable;
 ...
 */
public class MicrovideoWebsocketMessageExecutor {
    ...
    public static void sendMessage(final SimpMessagingTemplate messagingTemplate, final WebsocketBusMessage message){
        EXECUTOR.submit(new MicrovideoWebsocketMessageRunnable(messagingTemplate, message));
    }
}
