 ...
 */
@Slf4j
public class MicrovideoWebsocketMessageRunnable implements Runnable {
    private SimpMessagingTemplate template;
    private WebsocketBusMessage message;

    public MicrovideoWebsocketMessageRunnable(final SimpMessagingTemplate template, final WebsocketBusMessage message) {
