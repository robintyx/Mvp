package cn.microvideo.framework3.component.transfer.kafka.plugins.kafka.consumer.config;
 ...
 */
@Configuration("MicrovideoChaeBusKafkaTransferConsumerConfiguration")
@EnableKafka
@Slf4j
@Getter
public class MicrovideoChaeBusKafkaTransferConsumerConfiguration {

    @Value("${microvideo.kafka.consumer.servers}")
    private String servers;
    @Value("${microvideo.kafka.consumer.enable-auto-commit}")
    private boolean enableAutoCommit;
    @Value("${microvideo.kafka.consumer.ack-mode}")
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory() {
        ...
        if(!enableAutoCommit&&StringUtils.isNotBlank(ackMode)){
